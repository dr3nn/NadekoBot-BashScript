...
if [ $choice -eq 1 ] ; then
	...
	curl -L https://github.com/dr3nn/NadekoBot-BashScript/raw/master/nadeko_installer_latest.sh | sh
	echo ""
	...
	if [ $choice -eq 2 ] ; then
		echo ""
		echo "Downloading NadekoBot, please wait."
		curl -L https://github.com/dr3nn/NadekoBot-BashScript/raw/master/nadeko_installer.sh | sh
		echo ""
		...
		if [ $choice -eq 3 ] ; then
			...
			curl -L https://github.com/dr3nn/NadekoBot-BashScript/raw/master/nadeko_run.sh | sh
			echo ""
			...
			if [ $choice -eq 4 ] ; then
				...
				sleep 5s
				wget -N https://github.com/dr3nn/NadekoBot-BashScript/raw/master/NadekoAutoRestartAndUpdate.sh && bash NadekoAutoRestartAndUpdate.sh
				echo ""
